                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="role" class="form-select" required>
                                                ...
                                                <option value="petugas" {{ $dataUser->role == 'petugas' ? 'selected' : '' }}>
                                                    Petugas</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @if ($dataUser->profile_photo)
                                                <div class="mb-2">
                                                    <img src="{{ asset('storage/' . $dataUser->profile_photo) }}"
                                        ...
                                        <div class="mb-3 text-center">
                                            <img src="{{ asset('storage/profile-photos/' . $dataUser->profile_photo) }}" class="rounded-circle"
